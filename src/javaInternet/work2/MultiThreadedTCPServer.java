...
public class MultiThreadedTCPServer {
    ...
    private static final Logger logger = Logger.getLogger(MultiThreadedTCPServer.class);
    ...
    private static class ClientHandler implements Runnable {
        ...
        public void run() {
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
                ...
                logger.error("Error occurred in client handler:", e);
            } finally {
                try {
                    clientSocket.close();
                } catch (IOException e) {
