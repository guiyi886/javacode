...
public class IncomeTaxCal {
    public static void main(String[] args) {
         ...
         */
        Person person1 = new Person(0, 1, true, 1, false, 0);
        Person person2 = new Person(2, 2, false, 0, true, 1);
        Person person3 = new Person(0, 1, false, 1, true, 2);
        Person person4 = new Person(0, 1, true, 1, false, 0);
        Person person5 = null;

        int cal1 = incomeTaxCalculator.cal(person1, 10000);
        int cal2 = incomeTaxCalculator.cal(person2, 30000);
        int cal3 = incomeTaxCalculator.cal(person3, 50000);
        ...
        int cal4 = incomeTaxCalculator.cal(person4, -10000);
        int cal5 = incomeTaxCalculator.cal(person5, 10000);
